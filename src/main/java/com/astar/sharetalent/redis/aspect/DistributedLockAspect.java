package com.astar.sharetalent.redis.aspect;

import com.astar.sharetalent.common.annotation.DistributedLock;
...
public class DistributedLockAspect {
    ...
    @Pointcut("@annotation(com.astar.sharetalent.common.annotation.DistributedLock)")
    ...
    private String getBaseKey(ProceedingJoinPoint pjp) {
        ...
        for (Object arg : args) {
            if (arg instanceof BaseDo) {
                BaseDo param0BaseModel = (BaseDo) arg;
